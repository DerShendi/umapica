...
public class RenderPipeline {
    ...
    /**
 * @deprecated Neo: use {@link #RenderPipeline(Identifier, Identifier, Identifier,
 *             ShaderDefines, List, List, Optional, DepthTestFunction,
 *             PolygonMode, boolean, boolean, boolean, boolean, LogicOp,
 *             VertexFormat, VertexFormat.Mode, float, float, int, Optional)}
 *             instead
 */
    @Deprecated
