...
public class DebugRenderer {
    ...
    public void emitGizmos(Frustum frustum, double camX, double camY, double camZ, float partialTick) {
        Minecraft minecraft = Minecraft.getInstance();
        ...
        for (DebugRenderer.SimpleDebugRenderer debugrenderer$simpledebugrenderer : this.renderers) {
            debugrenderer$simpledebugrenderer.emitGizmos(camX, camY, camZ, debugvalueaccess, frustum, partialTick);
        }
    }
    ...
    public interface SimpleDebugRenderer {
        void emitGizmos(double camX, double camY, double camZ, DebugValueAccess debugValueAccess, Frustum frustum, float partialTick);
    }
}
